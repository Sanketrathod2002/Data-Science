...
x*17 # To create table of 17.

# Sequence
1:10 # To print the range of sequence numbers
...
seq(19,190,19) # Using sequencing print the table of 19.
...
# Repetition
rep(45,7) # To repeat any for many times.
rep("Mango",5) # To repeat any character for many times.
